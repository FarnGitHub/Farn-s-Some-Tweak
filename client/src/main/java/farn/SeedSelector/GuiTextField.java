...
public class GuiTextField extends Screen {
	...
	public GuiTextField(Screen bh1, TextRenderer kd2, int i3, int i4, int i5, int i6, String string7) {
		this.parentGuiScreen = bh1;
	...
	public void textboxKeyTyped(char c1, int i2) {
		if(this.isEnabled && this.isFocused) {
			if(c1 == 22) {
				String string3 = Screen.getClipboard();
				if(string3 == null) {
					string3 = "";
				}
			...
			if(getAllowedCharacters().indexOf(c1) >= 0 && (this.text.length() < this.maxStringLength || this.maxStringLength == 0)) {
